    ...
    return (
        <div>
            ...
            <div className="conge-user">
                <h2>My Congés</h2>
                    {/* Button to navigate to AddConge */}
                <button onClick={() => navigate('/AddConge')} className="add-conge-button">
                    Request Leave
                </button>
