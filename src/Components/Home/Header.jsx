                ...
                <div className="nav-bar">
                    ...
                    <div className="menu">
                        <ul className="nav-links">
                            <li><Link to="/dashboard"><i className='bx bx-home'></i></Link></li>
                            <li><Link to="/poste"><i className='bx bx-edit'></i> </Link></li>
                            <li 
                            ...
                            <li><Link to="/home"><i className='bx bx-briefcase'></i></Link></li>
                            <li><Link to={"/allCongeManager"}><i className='bx bx-calendar'></i></Link></li>
                            <li><Link to="/AllTimeSheetManager"><i className='bx bx-time-five'></i></Link></li>
                            <li className="profile-menu">
                                <a href="#"><i className='bx bx-user'></i></a>
                                <ul className="dropdown">
                                    <li><Link to="/profile"><i className='bx bx-user'></i> Profile</Link></li>
                                    <li><Link to="/home"><i className='bx bx-cog'></i> Settings</Link></li>
